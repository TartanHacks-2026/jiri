...
declare module '@agentuity/frontend' {
	...
	'GET /api/jiri/session/:sessionId/history': {
				inputSchema: never;
				outputSchema: never;
				stream: false;
		...
		jiri: {
			...
			session: {
				sessionId: {
					history: {
						/**
						 * Route: GET /api/jiri/session/:sessionId/history
						 */
				...
				"session": {
						"sessionId": {
								"history": {
										"get": {
												"type": "api",
												"path": "/api/jiri/session/:sessionId/history",
												"pathParams": [
														"sessionId"
												]
										}
